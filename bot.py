...
def ask_deepseek(user_input, roll, char_data, world):
    ...
    data = {"model": "qwen/qwen-2.5-7b-instruct:free", "messages": [{"role": "system", "content": "Ты — талантливый писатель и суровый Мастер D&D."}, {"role": "user", "content": prompt}], "temperature": 0.95, "max_tokens": 1000}
    try:
